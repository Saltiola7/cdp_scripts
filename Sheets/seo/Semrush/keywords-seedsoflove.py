...
for file in files:
    ...
    sns.lineplot(data=df, x='Date', y='Organic Keywords', color=file['color'], label=file['label'])
...
# Save the plot
save_path = '/Users/tis/Dendron/notes/SEO/Semrush/seedsoflove/all_keywords.png'
